...
return array (
		...
		'db' => array (
				...
				'username' => 'root',
				'password' => 'root',
				'dsn' => 'mysql:dbname=financeiro;host=localhost',
		...
		// configuraçåo para o envio de emails
		'email' => array (
				'credentials' => array (
						'from_mail' => 'manoel.tsf@gmail.com',
						'from_name' => 'Manoel Filho' 
				),
				...
				'smtp' => array (
						...
						'connection_config' => array (
								'ssl' => 'tls',
								'username' => 'manoel.tsf@gmail.org.br',
								'password' => 'manoelfilho585254' 
						) 
				) 
		),
